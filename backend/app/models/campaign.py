...
class Message(SQLModel, table=True):
    ...
    template_version: int = Field(sa_column=Column(Integer, nullable=True))  # V2.2: Required in Python, nullable in DB for backward compat
    template_id: str = Field(sa_column=Column(String, index=True, nullable=True))  # V2.2: Required in Python, nullable in DB for backward compat
